...
import { ArrowLeft, Briefcase, Building, Calendar, User, Mail, Phone, GraduationCap, FileText, Send, CheckCircle } from 'lucide-react';
...
export default function ApplyPage() {
  ...
  if (isDeadlinePassed) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="text-center max-w-md">
          <Calendar className="h-20 w-20 text-red-400 mx-auto mb-4" />
